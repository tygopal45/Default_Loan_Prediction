...
# recreate the scorer the pickle expects
roc_auc_scorer = make_scorer(roc_auc_score, needs_threshold=True)



#load models at top of app to load into memory only one time
with open('/Users/gopaljee45/Desktop/codinG/SA_2025/Default_Loan_Prediction/Jupyter_Notebooks/Models/xgb_cv_final.pkl', 'rb') as f:
    clf_individual = pickle.load(f)
#load models at top of app to load into memory only one time
with open('/Users/gopaljee45/Desktop/codinG/SA_2025/Default_Loan_Prediction/Jupyter_Notebooks/Models/gb_cv_compact_joint.pkl', 'rb') as f:
    clf_joint = pickle.load(f)

with open('/Users/gopaljee45/Desktop/codinG/SA_2025/Default_Loan_Prediction/Jupyter_Notebooks/Models/knn_regression.pkl', 'rb') as f:
    knn = pickle.load(f)    
ss = StandardScaler()
#feature space
